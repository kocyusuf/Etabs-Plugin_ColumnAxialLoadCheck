...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.control_button.setGeometry(QtCore.QRect(10, 110, 93, 28))
        ...
        self.combos_box = QtWidgets.QComboBox(self.groupBox)
        self.combos_box.setGeometry(QtCore.QRect(10, 30, 73, 22))
        self.combos_box.setObjectName("combos_box")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Kolonlarda Eksenel Yük Tahkiki"))
